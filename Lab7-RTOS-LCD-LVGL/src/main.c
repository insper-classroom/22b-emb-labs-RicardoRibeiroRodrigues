...
void lv_termostato(void) {
	...
	lv_obj_align(btnDown, LV_ALIGN_BOTTOM_RIGHT, -10, -30);
	...
	lv_obj_align_to(btnUp, btnDown, LV_ALIGN_OUT_LEFT_MID, -33, -10);
	...
	lv_obj_align(labelSetValue, LV_ALIGN_RIGHT_MID, -28, -30);
